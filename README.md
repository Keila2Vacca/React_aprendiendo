...
|--------|-------------|-----------------|
| **Keila** | `feature/keila` | useState, useReducer, useEffect, useLayoutEffect, useDebugValue |
...
**useReducer** — Es una agenda organizada y se usa cuando las cosas se ponen complicadas. En lugar de cambiar los datos a lo loco, se manda "mensajes" (acciones)
**useEffect** — Este es el que se encarga de las cosas que pasan "fuera" del componente.
**useLayoutEffect** — Es casi igual al anterior pero este trabaja màs ràpido sin que el usuario note parpedeo.
