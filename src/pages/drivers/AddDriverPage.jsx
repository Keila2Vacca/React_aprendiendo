...
const AddDriverPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => {
        navigate(`/drivers/view/${docRef.id}`);
      }, 1500);
    } catch (err) {
      console.error("Error adding driver:", err);
      setError('Error al crear el conductor. Por favor intente nuevamente.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="animate-fade-up delay-100" style={{
          ...
          {success && (
            <div style={{
              ...
              <span>¡Conductor creado exitosamente! Redirigiendo...</span>
            </div>
          )}
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem', paddingTop: '1.5rem', borderTop: '1px solid var(--gray-200)' }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none', cursor: loading ? 'not-allowed' : 'pointer', fontWeight: 600, fontSize: '.875rem',
